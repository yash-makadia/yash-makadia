...
<!--       <img src="https://media.tenor.com/uF7aJqxcM6QAAAAi/digital-skola-bertalenta-digital.gif" alt="Data Animation" style="width: 300px; border: 2px solid #ffffff; border-radius: 8px; padding: 5px; box-shadow: 0 0 8px rgba(255, 255, 255, 0.3);"> -->
      <img src="https://github.com/yash-makadia/yash-makadia/blob/master/20250421_2150_Futuristic%20Data%20Analyst_simple_compose_01jsdjx8whfvy9j02eafqh20xy.png" alt="Data Illustration" style="width: 300px; border: 2px solid #ffffff; border-radius: 8px; padding: 5px; box-shadow: 0 0 8px rgba(255, 255, 255, 0.3);">
    </div>
    <!-- About Section -->
